...
public:
	...
	virtual int xyuv(  const std::string& path, bool isDebug=0) = 0;	// 提取视频文件中的yuv
...
public:
	...
	static void getFileType(const std::string& filename,std::string& fileType){	//锟斤拷取锟侥硷拷锟斤拷锟斤拷
